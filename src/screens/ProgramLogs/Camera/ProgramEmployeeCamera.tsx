...
const ProgramEmployeeCamera = ({ navigation }: any) => {
    ...
    useEffect(() => {
        ...
        AsyncStorage.getItem('scannedBarcodedEmployeesData')
            .then((data) => {
                if (data) {
            ...
            barcodes.forEach(async (scannedBarcode) => {
                if (scannedBarcode.rawValue && scannedBarcode.rawValue !== '') {
                    ...
                    dispatch(findEmployeeAsync(data)).then((response: any) => {
                        ...
                        AsyncStorage.setItem('scannedBarcodedEmployeesData', JSON.stringify(updatedScannedData))
                            .then(() => {
                        ...
                        AsyncStorage.setItem('programEData', JSON.stringify(updatedScannedEData))
                            .then(() => {
                                console.log('scannedEData stored in AsyncStorage');
                            })
                            .catch((error) => {
...
export default ProgramEmployeeCamera
