...
const EditMachineCamera = ({ navigation }: any) => {
    ...
    useEffect(() => {
        ...
        AsyncStorage.getItem('editedMData')
            ...
            AsyncStorage.getItem('scannedEditedMachinesData')
            .then((data) => {
                if (data) {
            ...
            barcodes.forEach(async (scannedBarcode) => {
                if (scannedBarcode.rawValue && scannedBarcode.rawValue !== '') {
                    ...
                    dispatch(findMachineAsync(data)).then((response: any) => {
                        ...
                        AsyncStorage.setItem('scannedEditedMachinesData', JSON.stringify(updatedScannedData))
                            .then(() => {
                        ...
                        AsyncStorage.setItem('editedMData', JSON.stringify(updatedScannedEData))
                            .then(() => {
                                console.log('scannedEData stored in AsyncStorage');
                            })
                            .catch((error) => {
    ...
    const finishAllotment = () => {
        ...
        navigation.navigate("EditAlotment", { ...existingParams, params2: scannedMachineData });
    };
...
export default EditMachineCamera
